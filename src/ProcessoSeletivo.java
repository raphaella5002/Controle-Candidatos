...
public class ProcessoSeletivo {
    public static void main(String[] args) {
        String [] candidatos = {"Felipe", "Jéssica", "Fernanda", "Rafaela", "Marcelo"};
...
static void EntrandoEmContato (String candidato) {
    ...
    do {
        ...
        System.out.print("NÃO CONSEGUIMOS CONTATO COM " + candidato + " NÚMERO MÁXIMO DE TANTATIVAS: " + tentativasRealizadas +" TENTATIVAS.");
    }
}
    ...
    static void seleçãoCandidatos () {
        String [] candidatos = {"Felipe", "Jéssica", "Fernanda", "Rafaela", "Marcelo", "Jonas", "Thiago", "Maria", "Guilherme", "Lívia"};
